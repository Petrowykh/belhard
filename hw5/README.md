...
Задача: Создать модель детектирования китайских марок автомобилей по логотипу
...
Для 6 брендов были сделаны по 10 скриншотов разных машин (датасет в проекте)
...
Обучение модели проводилось в самой среде, время обучения *около 18 мин*
